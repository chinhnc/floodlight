...
public class Link implements Comparable<Link> {
    ...
    // Viet them bien linkCosts
    private Integer linkCosts;
    
    /*===== Viet them ham get cost vao Link =====*/
    public Link(DatapathId srcId, OFPort srcPort, DatapathId dstId, OFPort dstPort, U64 latency, Integer linkCosts) {
        this.src = srcId;
    ...
    /*===== Viet them ham set va get Link Cost =====*/
    public Integer getLinkCosts() {
    	return linkCosts;
    }
    
    public void setLinkCosts(Integer linkCosts) {
    	this.linkCosts = linkCosts;
    }
    /*=== End ===*/
